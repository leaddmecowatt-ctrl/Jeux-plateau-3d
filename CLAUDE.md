...
| `assets/character/avatar.glb` | le personnage affiché : Seed-san (VirtualCast, licence VRM 1.0, crédit dans la bulle de règles), tenue recolorée, sans sac robot — produit par `tools/prepare_avatar.py` |
